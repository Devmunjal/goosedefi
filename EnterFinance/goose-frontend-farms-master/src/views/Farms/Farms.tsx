...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  return (
    <div>
      <img src={tokenMode ? "/images/page2.jpeg" : "/images/page3.jpeg"} alt="bg" style={{ position: "fixed", top: "0", left: "0", width: "100vw", height: "100%", zIndex: -10 }} />
      <Page>
        <div style={{background:"#FFFFFFC5", padding:"10px 0px"}}>
