...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 170 40" }, props),
        React.createElement("image", { width: "170", height: "40", href: isDark ? '/images/egg/logobigdark.png' : '/images/egg/logobig.png' })));
};
            ...
            React.createElement("div", null,
                React.createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); } },
                    React.createElement(Flex, { alignItems: "center" },
                        React.createElement(SunIcon, { color: isDark ? "textSubtle" : "text", width: "24px" }),
                        React.createElement(Text, { color: "textSubtle", mx: "4px" }, "/"),
                        React.createElement(MoonIcon, { color: isDark ? "text" : "textSubtle", width: "24px" })))),
            React.createElement("div", null,
