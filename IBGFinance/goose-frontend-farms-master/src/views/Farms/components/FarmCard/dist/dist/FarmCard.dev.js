...
var ExpandingWrapper = styled_components_1["default"].div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  height: ", ";\n  overflow: hidden;\n"], ["\n  height: ", ";\n  overflow: hidden;\n"])), function (props) {
  return props.expanded ? '100%' : '0px';
});

var FarmCard = function FarmCard(_a) {
  var farm = _a.farm,
      removed = _a.removed,
      cakePrice = _a.cakePrice,
      bnbPrice = _a.bnbPrice,
      ethereum = _a.ethereum,
      account = _a.account;
  var TranslateString = useI18n_1["default"]();

  var _b = react_1.useState(false),
      showExpandableSection = _b[0],
      setShowExpandableSection = _b[1]; // const isCommunityFarm = communityFarms.includes(farm.tokenSymbol)
  ...
  var totalValueFormated = totalValue ? "$" + Number(totalValue).toLocaleString(undefined, {
  ...
  var quoteTokenAdresses = farm.quoteTokenAdresses,
      quoteTokenSymbol = farm.quoteTokenSymbol,
      tokenAddresses = farm.tokenAddresses,
      risk = farm.risk;
  return react_1["default"].createElement(FCard, null, farm.tokenSymbol === 'ENTER' && react_1["default"].createElement(StyledCardAccent, null), react_1["default"].createElement(CardHeading_1["default"], {
    lpLabel: lpLabel,
  ...
  }), !removed && react_1["default"].createElement(uikit_1.Flex, {
    justifyContent: 'space-between',
    alignItems: 'center'
  }, react_1["default"].createElement(uikit_1.Text, null, TranslateString(352, 'APR'), ":"), react_1["default"].createElement(uikit_1.Text, {
    bold: true,
    style: {
      display: 'flex',
      alignItems: 'center'
    }
  }, farm.apy ? react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement(ApyButton_1["default"], {
    lpLabel: lpLabel,
    ...
    cakePrice: cakePrice,
    apy: farm.apy
  }), farmAPY, "%") : react_1["default"].createElement(uikit_1.Skeleton, {
    height: 24,
    width: 80
  }))), react_1["default"].createElement(uikit_1.Flex, {
    justifyContent: 'space-between'
  }, react_1["default"].createElement(uikit_1.Text, null, TranslateString(318, 'Earn'), ":"), react_1["default"].createElement(uikit_1.Text, {
    bold: true
  }, earnLabel)), react_1["default"].createElement(uikit_1.Flex, {
    justifyContent: 'space-between'
  }, react_1["default"].createElement(uikit_1.Text, {
    style: {
      fontSize: '24px'
    }
  }, TranslateString(10001, 'Deposit Fee'), ":"), react_1["default"].createElement(uikit_1.Text, {
    bold: true,
    style: {
      fontSize: '24px'
    }
  }, farm.depositFeeBP / 100, "%")), react_1["default"].createElement(CardActionsContainer_1["default"], {
    farm: farm,
    ethereum: ethereum,
    account: account
  }), react_1["default"].createElement(Divider, null), react_1["default"].createElement(ExpandableSectionButton_1["default"], {
    onClick: function onClick() {
      return setShowExpandableSection(!showExpandableSection);
    },
    expanded: showExpandableSection
  }), react_1["default"].createElement(ExpandingWrapper, {
    expanded: showExpandableSection
  }, react_1["default"].createElement(DetailsSection_1["default"], {
    removed: removed,
