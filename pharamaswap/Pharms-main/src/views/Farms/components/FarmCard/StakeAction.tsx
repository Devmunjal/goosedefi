...
const StakeAction: React.FC<FarmCardActionsProps> = ({ stakedBalance, tokenBalance, tokenName, pid, depositFeeBP }) => {
  ...
  const renderStakingButtons = () => {
    ...
    return rawStakedBalance === 0 ? (
      ...
      <IconButtonWrapper>
        <IconButton variant="text" onClick={openModal} mr="6px">
          <MinusIcon color="textDisabled" />
        </IconButton>
        <IconButton variant="text" onClick={onPresentDeposit}>
          <AddIcon color="textDisabled" />
        </IconButton>
        <Modal
          isOpen={modalIsOpen}
