      ...
      {toggleCard ? (
        <FCard toggleCard={toggleCard}>
          <div style={{ width: '100%', justifyContent: 'space-between', display: 'flex', alignItems: 'center' }}>
            ...
            <div style={{ width: '20%' }}>
              {!removed && (
                <div style={{ alignItems: 'center' }}>
                  <Text color="textColor">{TranslateString(352, 'APR')}</Text>
                  <Text color="textSubtle" bold style={{ alignItems: 'center', display: 'flex', justifyContent: 'center' }}>
                    {farm.apy ? (
                      <>
                        <ApyButton
                          lpLabel={lpLabel}
                          ...
                          apy={farm.apy}
                        />
                        <Text color="textColor" style={{ paddingLeft: '15px' }}>{farmAPY}%</Text>
                      </>
                    ) : (
            ...
            <div style={{ width: '15%' }}>
              <Text color="textColor">{TranslateString(318, 'Earn')}</Text>
              <Text color="textSubtle" bold>{earnLabel}</Text>
            </div>
            <div style={{ width: '20%' }}>
              <Text color="textColor" style={{ fontSize: '24px' }}>{TranslateString(10001, 'Deposit Fee')}</Text>
      ...
      />
        ...
        <FCard>
          ...
          <Flex justifyContent="space-between">
            ...
            <Text color="textColor" bold>{earnLabel}</Text>
          </Flex>
          <Flex justifyContent="space-between">
            <Text color="textSubtle" style={{ fontSize: '24px' }}>{TranslateString(10001, 'Deposit Fee')}:</Text>
            <Text color="textColor" bold style={{ fontSize: '24px' }}>
              {farm.depositFeeBP / 100}%
            </Text>
          </Flex>
          <CardActionsContainer farm={farm} ethereum={ethereum} account={account} />
