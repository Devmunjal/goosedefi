...
var Icon$C = function (props) {
    return (React__default['default'].createElement("img", __assign({}, props, { src: "/images/ticket.png" }))
...
var Image = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper, __assign({ ref: imgRef }, otherProps), isLoaded ? React__default['default'].createElement(StyledImage, { src: src, alt: alt, positionTop: positionTop, height: imgHeight }) : React__default['default'].createElement(Placeholder, null)));
};
        ...
        React__default['default'].createElement(ModalHeader, null,
            React__default['default'].createElement(ModalTitle, null,
                onBack && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React__default['default'].createElement(Icon$5, { color: "textColor" }))),
                React__default['default'].createElement(Heading, { color: "textColor", style: { fontSize: "25px" } }, title)),
            !hideCloseButton && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React__default['default'].createElement(Icon$k, { color: "#FFFFFF" })))),
...
var Icon$I = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 25" }, props),
        React__default['default'].createElement("image", { width: "25", height: "25", href: props.isActive ? "/images/greenfarmicon.png" : '/images/farmicon.png' }))
...
var Icon$M = function (props) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 25" }, props),
        React__default['default'].createElement("image", { width: "25", height: "25", href: props.isActive ? "/images/greenhomeicon.png" : '/images/homeicon.png' }))
    //     <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" height="20" width="20" {...props}
    ...
    //        c1.522-1.906,2.189-4.145,1.991-6.716C460.068,229.007,459.021,226.961,457.122,225.438z" fill="#75dfee"/>
    //    </g>
    //  </g>
    //  <g>
    //  </g>
...
var Icon$N = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 25" }, props),
        React__default['default'].createElement("image", { width: "25", height: "25", href: props.isActive ? "/images/greenifoicon.png" : '/images/ifoicon.png' }))
    // <Svg viewBox="0 0 24 24" {...props}>
...
var Icon$O = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 25" }, props),
        React__default['default'].createElement("image", { width: "25", height: "25", href: props.isActive ? "/images/greeninfoicon.png" : '/images/infoicon.png' }))
    // dummy
    // <Svg viewBox="0 0 24 24" {...props}>
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "-10 0 205 26" }, props),
        React__default['default'].createElement("image", { width: "80", height: "26", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var Icon$R = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 25" }, props),
        React__default['default'].createElement("image", { width: "25", height: "25", href: props.isActive ? "/images/greenmoreicon.png" : '/images/moreicon.png' }))
    // <Svg viewBox="0 0 24 24" {...props}>
...
var Icon$S = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 25" }, props),
        React__default['default'].createElement("image", { width: "25", height: "25", href: props.isActive ? "/images/greennfticon.png" : '/images/nfticon.png' }))
    // <Svg viewBox="0 0 24 24" {...props}>
    ...
    // </Svg>
    // <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 128 128" {...props}><g><path d="M64,0a64,64,0,1,0,64,64A64.073,64.073,0,0,0,64,0ZM107.968,105.49,99.84,97.362a48.808,48.808,0,0,0,13.116-31.615h11.5A60.261,60.261,0,0,1,107.968,105.49ZM15.041,62.361a1.729,1.729,0,0,0-.6-.114H4.062a1.729,1.729,0,0,0-.52.088A60.262,60.262,0,0,1,20.032,22.5l8.128,8.128A48.806,48.806,0,0,0,15.041,62.361Zm82.324-34.2A48.8,48.8,0,0,0,65.75,15.042V3.541a60.265,60.265,0,0,1,39.743,16.488ZM62.25,15.042A48.8,48.8,0,0,0,30.635,28.157l-8.128-8.128A60.261,60.261,0,0,1,62.25,3.541ZM64,18.5A45.5,45.5,0,1,1,18.5,64,45.551,45.551,0,0,1,64,18.5ZM30.392,100.08a1.768,1.768,0,0,0,.218-.267,48.81,48.81,0,0,0,31.64,13.14v11.5a60.259,60.259,0,0,1-39.758-16.5,1.681,1.681,0,0,0,.162-.133ZM65.75,112.953A48.8,48.8,0,0,0,97.365,99.837l8.128,8.128A60.265,60.265,0,0,1,65.75,124.453Zm58.706-50.706h-11.5A48.808,48.808,0,0,0,99.84,30.632l8.128-8.128A60.265,60.265,0,0,1,124.456,62.247ZM3.542,65.659a1.729,1.729,0,0,0,.52.088H14.437a1.729,1.729,0,0,0,.6-.114A48.8,48.8,0,0,0,28.184,97.387a1.768,1.768,0,0,0-.267.218l-7.737,7.738a1.578,1.578,0,0,0-.133.163A60.263,60.263,0,0,1,3.542,65.659Z" fill="#75dfee"/><path d="M38.862,53.893a1.749,1.749,0,0,0-.908,1.808l5,32.875a1.751,1.751,0,0,0,1.73,1.487H83.312a1.749,1.749,0,0,0,1.73-1.487l5-32.875a1.75,1.75,0,0,0-2.915-1.551L72.486,67.63,65.544,54.614a1.75,1.75,0,0,0-3.088,0L55.514,67.63,40.869,54.15A1.745,1.745,0,0,0,38.862,53.893ZM54.809,71.737a1.749,1.749,0,0,0,2.729-.464L64,59.156l6.462,12.117a1.749,1.749,0,0,0,2.729.464L85.837,60.1,81.809,86.563H46.191L42.163,60.1Z" fill="#75dfee"/><path d="M64,51.563a6.813,6.813,0,1,0-6.813-6.813A6.821,6.821,0,0,0,64,51.563Zm0-10.125a3.313,3.313,0,1,1-3.313,3.312A3.315,3.315,0,0,1,64,41.438Z" fill="#75dfee"/><path d="M88.316,51.563A6.813,6.813,0,1,0,81.5,44.75,6.821,6.821,0,0,0,88.316,51.563Zm0-10.125A3.313,3.313,0,1,1,85,44.75,3.316,3.316,0,0,1,88.316,41.438Z" fill="#75dfee"/><path d="M39.684,51.563a6.813,6.813,0,1,0-6.813-6.813A6.821,6.821,0,0,0,39.684,51.563Zm0-10.125a3.313,3.313,0,1,1-3.313,3.312A3.315,3.315,0,0,1,39.684,41.438Z" fill="#75dfee"/></g></svg>
    //     <svg version="1.1" id="Capa_1"  x="0px" y="0px" width="20" height="20"
    // 	 viewBox="0 0 232.068 232.068" {...props} >
    // <g>
    ...
    // 		v18H204.701z" fill="#75dfee"/>
    // 	<path d="M49.999,116.034c0,36.412,29.623,66.036,66.035,66.036s66.036-29.624,66.036-66.036s-29.624-66.036-66.036-66.036
    // 		S49.999,79.622,49.999,116.034z M116.008,153.231l-31.423-36.909l31.423-36.909l31.423,36.909L116.008,153.231z" fill="#75dfee"/>
    // </g>
    // <g>
    // </g>
    // <g>
...
var Icon$T = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 25" }, props),
        React__default['default'].createElement("image", { width: "25", height: "25", href: props.isActive ? "/images/greenpoolicon.png" : '/images/poolicon.png' }))
    // <Svg viewBox="0 0 24 24" {...props}>
    ...
    //   />
    // </Svg>
    // <svg id="Capa_1" enable-background="new 0 0 512 512" height="20" viewBox="0 0 512 512" width="20" xmlns="http://www.w3.org/2000/svg" {...props}><g><circle cx="61" cy="286" r="45" fill="#75dfee"/><path d="m451 361c-33.137 0-60 26.863-60 60v7.509l-120-90.007v-67.502h45v-90c0-33.137-26.863-60-60-60s-60 26.863-60 60v90h45v67.5l-120 90v-7.5c0-33.137-26.863-60-60-60s-61 26.863-61 60v91h121v-46.015l135-101.235 135 101.246v46.004h121v-91c0-33.137-27.863-60-61-60z" fill="#75dfee"/><circle cx="451" cy="286" r="45" fill="#75dfee"/><path d="m256 91c24.853 0 45-20.147 45-45s-20.147-46-45-46-45 21.147-45 46 20.147 45 45 45z" fill="#75dfee"/></g></svg>
    //     <svg id="Layer_5" enable-background="new 0 0 64 64" height="20" viewBox="0 0 64 64" width="20" xmlns="http://www.w3.org/2000/svg" {...props}><g><path d="m22.649 53-3.554 8h13.811l-3.556-8z" fill="#75dfee"/><path d="m15.539 53 2.461 5.538 2.462-5.538z" fill="#75dfee"/>
    // <path d="m8 53h-1-.351l-3.554 8h13.811l-3.556-8z" fill="#75dfee"/><path d="m42.905 51-3.554-8h-17.812l3.461 7.788v.212z" fill="#75dfee"/><path d="m45 53h-13.461l3.461 7.788v.212h13.905l-3.554-8z" fill="#75dfee"/><path d="m44.261 15 3.473-11.286-2.333-.583-3.449 4.599-2.413-3.618-3.232.647 3.413 10.241z" fill="#75dfee"/><path d="m52.844 24.303-5.137-3.303h-11.414l-5.137 3.303c-5.107 3.283-8.156 8.867-8.156 14.938 0 .589.04 1.175.097 1.759h17.553l1.778 4h.572c1.654 0 3-1.346 3-3s-1.346-3-3-3h-2c-2.757 0-5-2.243-5-5s2.243-5 5-5v-2h2v2h5v5h-2v-3h-5c-1.654 0-3 1.346-3 3s1.346 3 3 3h2c2.757 0 5 2.243 5 5 0 2.653-2.084 4.809-4.697 4.969l1.697 3.819v.212h1.649l2.251 5.064c7.162-2.41 12.1-9.199 12.1-16.823 0-6.071-3.049-11.655-8.156-14.938zm-25.842 14.713-2-.031c.072-4.539 2.094-8.821 5.545-11.747l1.293 1.525c-3.012 2.553-4.775 6.291-4.838 10.253zm6.071-11.187-1.117-1.658 1.566-1.012 1.082 1.682zm19.523 24.091-1.191-1.605c.496-.368.974-.775 1.419-1.21l1.396 1.432c-.51.496-1.057.962-1.624 1.383zm3.047-2.972-1.576-1.23c.38-.487.732-1.007 1.049-1.545l1.725 1.014c-.362.613-.764 1.206-1.198 1.761zm1.356-9.906h2l.001.199c0 .643-.04 1.288-.118 1.92l-1.984-.246c.068-.55.102-1.113.102-1.674zm-.456 3.701 1.934.514c-.182.685-.412 1.364-.686 2.02l-1.846-.77c.239-.571.44-1.165.598-1.764z" fill="#75dfee"/><path d="m9.095 51h12.256 1.555l-3.556-8h-6.701z" fill="#75dfee"/><path d="m37.613 15-2.542-7.626-1.97.246c-1.068.134-1.902.963-2.069 1.996l5.382 5.384z" fill="#75dfee"/><path d="m34 17c-.552 0-1 .448-1 1s.448 1 1 1h16c.552 0 1-.448 1-1s-.448-1-1-1z " fill="#75dfee"/><path d="m47.586 15 5.383-5.384c-.167-1.033-1.001-1.862-2.069-1.996l-2.191-.274-2.355 7.654z" fill="#75dfee"/><path d="m14 13h2v2h-2z" fill="#75dfee"/><path d="m14 17h2v2h-2z" fill="#75dfee"/><path d="m16 15h2v2h-2z" fill="#75dfee"/><path d="m12 15h2v2h-2z" fill="#75dfee"/><path d="m15 33h2v2h-2z" fill="#75dfee"/><path d="m15 37h2v2h-2z" fill="#75dfee"/><path d="m17 35h2v2h-2z" fill="#75dfee"/><path d="m13 35h2v2h-2z" fill="#75dfee"/><path d="m23 3h2v2h-2z" fill="#75dfee"/><path d="m23 7h2v2h-2z" fill="#75dfee"/><path d="m25 5h2v2h-2z" fill="#75dfee"/><path d="m21 5h2v2h-2z" fill="#75dfee"/><path d="m57 13h2v2h-2z" fill="#75dfee"/><path d="m57 17h2v2h-2z" fill="#75dfee"/><path d="m59 15h2v2h-2z" fill="#75dfee"/><path d="m55 15h2v2h-2z" fill="#75dfee"/><path d="m6 26h2v2h-2z" fill="#75dfee"/><path d="m6 30h2v2h-2z" fill="#75dfee"/><path d="m8 28h2v2h-2z" fill="#75dfee"/><path d="m4 28h2v2h-2z" fill="#75dfee"/><path d="m6 4h2v2h-2z" fill="#75dfee"/><path d="m6 8h2v2h-2z" fill="#75dfee"/><path d="m8 6h2v2h-2z" fill="#75dfee"/><path d="m4 6h2v2h-2z" fill="#75dfee"/></g></svg>
    );
};
...
var Icon$V = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("image", { width: "20", height: "21", href: props.isDark ? "/images/telegram.png" : "/images/telegramlight.png" })));
};

var Icon$W = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 25" }, props),
        React__default['default'].createElement("image", { width: "25", height: "25", href: '/images/ticketicon.png' }))
    // <Svg viewBox="0 0 24 24" {...props}>
    //   <path
    //     fillRule="evenodd"
    //     clipRule="evenodd"
    ...
    // </Svg>
    //     <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px"
    // 	 viewBox="0 0 477.867 477.867" width="20" height="20" {...props}>
    // <g>
    // 	<g>
    ...
    // 			c37.703,0,68.267-30.564,68.267-68.267S447.303,204.8,409.6,204.8z" fill="#75dfee"/>
    // 	</g>
    // </g>
    // <g>
    // </g>
    ...
    // </g>
    // </svg>
    /* <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="20" height="20" {...props}
         viewBox="0 0 512 512" >
    <g transform="translate(-1)">
        <g>
            <g>
                <path d="M83.286,210.286c0.031,10.869,1.084,21.712,3.145,32.384l79.881-21.312c-0.474-3.672-0.721-7.37-0.741-11.072
                    c-0.004-6.141,0.609-12.267,1.829-18.286l-79.415-21.394C84.911,183.61,83.334,196.923,83.286,210.286z" fill="#75dfee"/>
                <path d="M184.058,265.143c-5.948-7.859-10.58-16.631-13.714-25.975l-79.598,21.239c7.065,23.238,18.936,44.732,34.843,63.086
                    L184.058,265.143z" fill="#75dfee"/>
                <path d="M289.43,380.873l-0.046-0.018l-21.312-79.881c-3.672,0.474-7.37,0.721-11.072,0.741
                    c-6.141,0.004-12.267-0.609-18.286-1.829l-21.339,79.387C240.996,385.006,265.578,385.551,289.43,380.873z" fill="#75dfee"/>
                <path d="M93.05,153.024l79.835,21.467c3.895-9.037,9.22-17.388,15.771-24.731l-58.359-58.441
                    C113.677,109.036,100.984,130.063,93.05,153.024z" fill="#75dfee"/>
                <path d="M221.206,294.4c-9.037-3.895-17.388-9.22-24.731-15.771l-58.203,58.112c17.67,16.613,38.62,29.344,61.504,37.376
                    L221.206,294.4z" fill="#75dfee"/>
                <path d="M257,61.842l8.229-16.357c0.617-1.273,0.93-2.672,0.914-4.087V0.256C263.107,0.101,260.063,0,257,0
                    c-3.063,0-6.107,0.101-9.143,0.229v41.143c-0.001,1.418,0.327,2.817,0.96,4.087L257,61.842z" fill="#75dfee"/>
                <path d="M257,283.429c40.396,0,73.143-32.747,73.143-73.143S297.396,137.143,257,137.143s-73.143,32.747-73.143,73.143
                    C183.902,250.663,216.623,283.383,257,283.429z M257,164.571c18.774-1.195,35.979,10.463,41.829,28.343
                    c3.535-1.662,7.734-0.895,10.454,1.909s3.357,7.025,1.587,10.507l-9.143,18.002c-0.455,0.857-1.041,1.637-1.737,2.313
                    c0,0-0.055,0.101-0.101,0.137c-0.046,0.037-0.247,0.137-0.366,0.238c-0.65,0.57-1.38,1.042-2.167,1.399
                    c-0.258,0.131-0.524,0.247-0.795,0.347c-0.957,0.358-1.968,0.549-2.99,0.567c-0.715,0.001-1.427-0.085-2.121-0.256
                    c-0.268-0.096-0.53-0.206-0.786-0.329c-1.146-0.399-2.203-1.02-3.109-1.829c-0.183-0.165-0.411-0.219-0.585-0.402l-13.285-13.861
                    c-2.558-2.667-3.259-6.611-1.776-9.996c1.482-3.385,4.857-5.545,8.551-5.473c-4.119-9.045-13.582-14.422-23.461-13.33
                    c-5.049,0-9.143-4.093-9.143-9.143S251.951,164.571,257,164.571z M212.273,197.285c0.995-1.935,2.654-3.447,4.672-4.261
                    c0.326-0.114,0.659-0.205,0.997-0.274c0.712-0.221,1.45-0.347,2.194-0.375c0.422-0.005,0.844,0.023,1.262,0.082
                    c0.385,0,0.77,0.027,1.152,0.082c0.282,0.097,0.557,0.213,0.823,0.347c0.409,0.137,0.806,0.305,1.189,0.503
                    c0.661,0.356,1.275,0.792,1.829,1.298c0.183,0.165,0.421,0.238,0.603,0.421l13.285,13.861c2.535,2.644,3.247,6.546,1.809,9.915
                    c-1.438,3.369-4.747,5.555-8.41,5.555c-0.064,0-0.128,0-0.192,0c4.143,9.044,13.631,14.401,23.515,13.275
                    c5.049,0,9.143,4.093,9.143,9.143c0,5.049-4.093,9.143-9.143,9.143c-18.762,1.201-35.963-10.435-41.829-28.297
                    c-3.535,1.662-7.735,0.895-10.454-1.909c-2.719-2.804-3.357-7.025-1.587-10.507L212.273,197.285z" fill="#75dfee"/>
                <path d="M229.571,38.921c-3.895,0.622-7.744,1.344-11.547,2.203l27.429,78.537c7.636-1.073,15.385-1.073,23.022,0l27.429-78.537
                    c-3.803-0.859-7.653-1.582-11.547-2.203v2.478c-0.004,4.255-0.992,8.452-2.889,12.261l-16.238,32.713
                    c-1.547,3.103-4.716,5.065-8.183,5.065c-3.467,0-6.636-1.961-8.183-5.065l-16.402-32.713c-1.897-3.809-2.886-8.005-2.889-12.261
                    V38.921z" fill="#75dfee"/>
                <path d="M143.546,78.693l58.597,58.651c7.708-5.834,16.298-10.402,25.445-13.531l-27.154-77.714
                    C179.56,53.222,160.248,64.287,143.546,78.693z" fill="#75dfee"/>
                <path d="M286.44,123.813c11.46,3.926,22.026,10.089,31.086,18.13l58.514-58.395c-17.919-16.765-39.208-29.517-62.446-37.403
                    L286.44,123.813z" fill="#75dfee"/>
                <path d="M284.429,1.829v18.624c77.233,10.881,140.085,67.641,158.757,143.369c0.046,0.146,0.155,0.247,0.201,0.402
                    c0.046,0.155,0,0.393,0,0.585c3.663,14.884,5.547,30.149,5.614,45.477c-0.039,17.772-2.559,35.451-7.488,52.526
                    c0,0.265,0,0.521,0,0.777c-0.103,0.256-0.219,0.506-0.347,0.75c-9.377,31.785-26.816,60.605-50.624,83.657
                    c-0.165,0.183-0.229,0.421-0.402,0.603c-0.309,0.233-0.633,0.447-0.969,0.64c-23.884,22.737-53.231,38.927-85.202,47.003
                    c-0.279,0.158-0.566,0.301-0.859,0.43c-0.532,0.119-1.074,0.19-1.618,0.21c-31.816,7.831-65.134,7.15-96.603-1.975
                    c-0.399-0.029-0.796-0.081-1.189-0.155c-0.238-0.064-0.402-0.238-0.622-0.311c-31.838-9.365-60.705-26.823-83.785-50.67
                    c-0.192-0.155-0.421-0.219-0.603-0.393c-0.233-0.309-0.447-0.633-0.64-0.969c-22.698-23.839-38.873-53.123-46.967-85.029
                    c-0.176-0.332-0.331-0.674-0.466-1.024c-0.04-0.346-0.061-0.694-0.064-1.042c-12.944-52.497-3.029-108.02,27.286-152.792
                    c30.314-44.772,78.186-74.595,131.736-82.07V1.829C119.716,16.281,39.922,113.496,47.164,224.061S146.198,420.604,257,420.604
                    s202.594-85.977,209.836-196.542S394.284,16.281,284.429,1.829z" fill="#75dfee"/>
                <path d="M370.271,341.705l-58.414-58.478c-7.859,5.948-16.631,10.58-25.975,13.714l21.239,79.598
                    C330.381,369.486,351.897,357.617,370.271,341.705z" fill="#75dfee"/>
                <path d="M394.143,484.571H119.857c-5.049,0-9.143,4.093-9.143,9.143V512h292.571v-18.286
                    C403.286,488.665,399.192,484.571,394.143,484.571z" fill="#75dfee"/>
                <path d="M329.942,155.429c5.948,7.859,10.58,16.631,13.714,25.975l79.68-21.266c-6.991-23.311-18.831-44.881-34.743-63.296
                    L329.942,155.429z" fill="#75dfee"/>
                <path d="M420.831,267.511l-79.717-21.431c-3.895,9.037-9.22,17.388-15.771,24.731l58.112,58.203
                    C400.068,311.345,412.799,290.395,420.831,267.511z" fill="#75dfee"/>
                <path d="M257,438.857c-18.49-0.002-36.911-2.252-54.857-6.702v34.13h109.714v-34.13C293.911,436.605,275.49,438.856,257,438.857z
                    " fill="#75dfee"/>
                <path d="M430.714,210.286c0-10.877-1.007-21.73-3.008-32.421l-80.018,21.349c0.474,3.672,0.721,7.37,0.741,11.072
                    c0.004,6.141-0.609,12.267-1.829,18.286l79.387,21.339C429.086,236.929,430.672,223.632,430.714,210.286z" fill="#75dfee"/>
            </g>
        </g>
    </g>
    <g>
...
var Icon$X = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 25" }, props),
        React__default['default'].createElement("image", { width: "25", height: "25", href: props.isActive ? "/images/greentradeicon.png" : '/images/tradeicon.png' }))
    // <Svg viewBox="0 0 24 24" {...props}>
    //   <path
    //     fillRule="evenodd"
    //     clipRule="evenodd"
    ...
    //   />
    // </Svg>
    // <svg id="Layer_1" enable-background="new 0 0 504.711 504.711" height="20" viewBox="0 0 504.711 504.711" width="20" xmlns="http://www.w3.org/2000/svg" {...props}><path d="m310.94 213.523v-104.196c0-8.836-7.163-16-16-16h-140.049v-51.586c0-14.117-17.038-21.321-27.163-11.462l-122.893 119.683c-6.454 6.285-6.439 16.654 0 22.925l122.893 119.685c10.112 9.847 27.163 2.669 27.163-11.462v-51.586h140.049c8.837-.001 16-7.165 16-16.001z" fill="#75dfee"/><path d="m499.876 331.841-122.892-119.685c-10.112-9.847-27.163-2.669-27.163 11.462v51.586h-140.049c-8.837 0-16 7.164-16 16v104.196c0 8.836 7.163 16 16 16h140.049v51.586c0 14.161 17.098 21.263 27.163 11.462l122.893-119.684c6.454-6.284 6.439-16.652-.001-22.923z" fill="#75dfee"/></svg>
    );
};
...
var Icon$_ = function (props) {
    ...
    // </Svg>
    // <svg id="Capa_1" enable-background="new 0 0 512.004 512.004" height="20" viewBox="0 0 512.004 512.004" width="20" xmlns="http://www.w3.org/2000/svg" {...props}><path d="m130.239 138.268-44.358 3.427c-12.343.954-23.336 7.423-30.162 17.748l-51.157 77.372c-5.177 7.83-6 17.629-2.203 26.213 3.798 8.584 11.603 14.566 20.878 16.003l40.615 6.29c9.501-50.42 32.245-100.716 66.387-147.053z" fill="#75dfee"/><path d="m226.682 448.151 6.291 40.615c1.437 9.275 7.419 17.08 16.002 20.877 3.571 1.58 7.351 2.36 11.112 2.36 5.283 0 10.529-1.539 15.102-4.563l77.374-51.156c10.325-6.827 16.794-17.821 17.746-30.162l3.427-44.358c-46.338 34.143-96.633 56.887-147.054 66.387z" fill="#75dfee"/><path d="m211.407 420c1.41 0 2.828-.116 4.243-.352 21.124-3.532 41.484-9.482 60.906-17.27l-166.93-166.93c-7.788 19.421-13.738 39.781-17.27 60.906-1.392 8.327 1.401 16.81 7.37 22.78l93.144 93.144c4.956 4.955 11.645 7.722 18.537 7.722z" fill="#75dfee"/><path d="m471.178 227.003c40.849-78.974 42.362-162.43 40.227-201.57-.731-13.411-11.423-24.103-24.835-24.834-6.373-.348-13.926-.599-22.439-.599-43.766 0-113.017 6.629-179.131 40.826-52.542 27.177-121.439 87.018-162.087 165.66.48.375.949.773 1.391 1.215l180 180c.442.442.839.91 1.214 1.39 78.642-40.649 138.483-109.546 165.66-162.088zm-173.48-118.763c29.241-29.241 76.822-29.244 106.065 0 14.166 14.165 21.967 33 21.967 53.033s-7.801 38.868-21.967 53.033c-14.619 14.619-33.829 21.93-53.032 21.932-19.209.001-38.41-7.309-53.033-21.932-14.166-14.165-21.968-33-21.968-53.033s7.802-38.868 21.968-53.033z" fill="#75dfee"/><path d="m318.911 193.092c17.545 17.545 46.095 17.546 63.64 0 8.499-8.5 13.18-19.8 13.18-31.82s-4.681-23.32-13.18-31.819c-8.772-8.773-20.296-13.159-31.82-13.159-11.523 0-23.047 4.386-31.819 13.159-8.499 8.499-13.181 19.799-13.181 31.819s4.681 23.321 13.18 31.82z" fill="#75dfee"/><path d="m15.305 421.938c3.839 0 7.678-1.464 10.606-4.394l48.973-48.973c5.858-5.858 5.858-15.355 0-21.213-5.857-5.858-15.355-5.858-21.213 0l-48.973 48.973c-5.858 5.858-5.858 15.355 0 21.213 2.929 2.929 6.768 4.394 10.607 4.394z" fill="#75dfee"/><path d="m119.765 392.239c-5.857-5.858-15.355-5.858-21.213 0l-94.155 94.155c-5.858 5.858-5.858 15.355 0 21.213 2.929 2.929 6.768 4.393 10.607 4.393s7.678-1.464 10.606-4.394l94.154-94.154c5.859-5.858 5.859-15.355.001-21.213z" fill="#75dfee"/><path d="m143.432 437.12-48.972 48.973c-5.858 5.858-5.858 15.355 0 21.213 2.929 2.929 6.768 4.394 10.606 4.394s7.678-1.464 10.606-4.394l48.973-48.973c5.858-5.858 5.858-15.355 0-21.213-5.857-5.858-15.355-5.858-21.213 0z" fill="#75dfee"/></svg>
    );
};
...
var MenuEntry = styled__default['default'].div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    ...
    return (isActive ? theme.colors.success : "transparent");
}, function (_a) {
...
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, null, links.map(function (entry) {
        ...
        var iconElement = React__default['default'].createElement(Icon, { isActive: entry.href === location.pathname, width: "24px", mr: "8px" });
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement("div", null,
            React__default['default'].createElement(Text, { color: "textSubtle", style: { fontSize: "14px" } }, "Account Balance"),
            React__default['default'].createElement(SocialEntry, null, cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
                ...
                React__default['default'].createElement(Text, { color: "textColor", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 })))),
        React__default['default'].createElement("div", null,
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement("table", { style: { width: "100%" } },
                    React__default['default'].createElement("tr", { style: { width: "50%" } },
                        React__default['default'].createElement("td", null,
                            React__default['default'].createElement("div", null,
                                React__default['default'].createElement(Text, { color: "textSubtle", style: { fontSize: "14px" } }, "Night Mode"),
                                React__default['default'].createElement(Toggle, { checked: isDark, onChange: function () { return toggleTheme(!isDark); } }))),
                        React__default['default'].createElement("td", { style: { alignItems: "middle", width: "50%" } },
                            React__default['default'].createElement(Text, { color: "textSubtle", style: { fontSize: "14px", textAlign: "center" } }, "Language"),
                            React__default['default'].createElement(Dropdown, { position: "top-right", target: React__default['default'].createElement(Button, { variant: "text", style: { padding: "0", height: "0", textAlign: "center", width: "100%" } },
                                    React__default['default'].createElement(Text, { color: "text", style: { fontWeight: 500, fontSize: "20px", paddingTop: "30px" } }, currentLang === null || currentLang === void 0 ? void 0 :
                                        currentLang.toUpperCase(),
                                        React__default['default'].createElement(Icon$7, null))) }, langs.map(function (lang) { return (React__default['default'].createElement(MenuButton, { key: lang.code, fullWidth: true, onClick: function () { return setLang(lang); }, 
                                // Safari fix
                                style: { minHeight: "32px", height: "auto" } }, lang.language)); }))))))),
        React__default['default'].createElement(SettingsEntry, null,
            React__default['default'].createElement(Flex, { style: { padding: "8px 15px", marginTop: "15px", marginLeft: "-8px", marginBottom: "10px", borderRadius: "30px", background: "" + (isDark ? "#2d2d2d" : "#c0c0c04f") } }, socials.map(function (social, index) {
                var Icon = Icons$1[social.icon];
                var iconProps = { width: "24px", color: "textSubtle", style: { cursor: "pointer", marginTop: "2px" } };
                ...
                //   );
                // }
                return (React__default['default'].createElement(Link, { style: { borderRadius: "50%", background: "" + (isDark ? "#2d2d2d" : "#c0c0c0c0"), padding: "2px" }, external: true, key: social.label, href: social.href, "aria-label": social.label, mr: mr },
                    React__default['default'].createElement(Icon, __assign({}, iconProps, { isDark: isDark }))));
            })))));
};
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Button, { variant: "secondary", mt: "10px", style: { textAlign: "center", width: "100%" } },
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#f5f6fa", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#e9f5f6", text: "#14c39a", textColor: "#000000", textDisabled: "#f7f8fa", textSubtle: "#989898", borderColor: "#E9EAEB", card: "#FFFFFF", cardBackground: '#FFFFFF', gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    }, bgMenu: '#fff' });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#fff", background: "#252525", backgroundDisabled: "#404040", contrast: "#FFFFFF", invertedContrast: "#393939", input: "#393939", primaryDark: "#252525", tertiary: "#404040", textColor: "#FFF", text: "#14c39a", textDisabled: "#393939", textSubtle: "#989898", borderColor: "#393939", card: "#404040", cardBackground: '#27262c', gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
    }, bgMenu: '#4e4c4f' });
...
var light$5 = {
    background: lightColors.bgMenu,
    hover: "#e9f5f6",
};
var dark$5 = {
    background: darkColors.bgMenu,
    hover: "#473d5d",
};
