...
var getDisabledStyles = function (_a) {
    ...
    return "\n    &:disabled,\n    &.button--disabled {\n      background-color: " + theme.colors.backgroundDisabled + ";\n      border-color: rgb(124, 124, 124) rgb(255, 255, 255) rgb(255, 255, 255) rgb(124, 124, 124);;\n      box-shadow: none;\n      color: " + theme.colors.textDisabled + ";\n      cursor: not-allowed;\n    }\n  ";
};
...
var Icon$P = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "2 0 24 26" }, props),
...
var Icon$R = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("image", { width: "25", height: "25", href: '/images/moreicon.png' })));
};
...
var StyledMenu = styled__default['default'].div(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n\ncolor: rgb(191, 4, 17);\nbackground: rgba(0, 0, 0, 0) url(\"https://win98icons.alexmeub.com/icons/png/windows-0.png\") no-repeat scroll 2px center / 24px;\n    background-color: rgba(0, 0, 0, 0);\npadding-left: 28px;\npadding-right: 5px;\nheight: 29px;\nmargin: 2px 3px;\nfont-weight: bold;\nborder-style: solid;\nborder-width: 2px;\nborder-color: rgb(255, 255, 255) rgb(124, 124, 124) rgb(124, 124, 124) rgb(255, 255, 255);\nborder-image: none 100% / 1 / 0 stretch;\nborder-radius: 0px;\ncursor:pointer;\nline-height: 1.5;\n"], ["\n\ncolor: rgb(191, 4, 17);\nbackground: rgba(0, 0, 0, 0) url(\"https://win98icons.alexmeub.com/icons/png/windows-0.png\") no-repeat scroll 2px center / 24px;\n    background-color: rgba(0, 0, 0, 0);\npadding-left: 28px;\npadding-right: 5px;\nheight: 29px;\nmargin: 2px 3px;\nfont-weight: bold;\nborder-style: solid;\nborder-width: 2px;\nborder-color: rgb(255, 255, 255) rgb(124, 124, 124) rgb(124, 124, 124) rgb(255, 255, 255);\nborder-image: none 100% / 1 / 0 stretch;\nborder-radius: 0px;\ncursor:pointer;\nline-height: 1.5;\n"])));
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(StyledMenu, { as: "div", onClick: togglePush, color: "textSubtle" }, "Start"),
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(Button, { size: "sm", onClick: function () { return window.open("https://presale.retroworld.io"); } }, "Presale"),
        React__default['default'].createElement("div", { onClick: function () { return window.open("https://twitter.com/RetroWorldDefi"); } },
            React__default['default'].createElement(Icon$Y, { width: "28px" })),
        React__default['default'].createElement("div", { onClick: function () { return window.open("https://retroworld.medium.com/"); } },
            React__default['default'].createElement(Icon$Z, { width: "28px" })),
        React__default['default'].createElement("div", { onClick: function () { return window.open("https://t.me/retroworldglobal"); } },
            React__default['default'].createElement(Icon$V, { width: "28px" })),
        React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
                onPresentAccountModal();
            } }, accountEllipsis)) : (React__default['default'].createElement(Button, { size: "sm", onClick: function () {
                onPresentConnectModal();
            }, style: { color: "#FFFFFF" } }, "CONNECT")))));
};

var Wrapper$1 = styled__default['default'].div(templateObject_1$E || (templateObject_1$E = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n"], ["\n  position: relative;\n  width: 100%;\n"])));
var StyledNav = styled__default['default'].nav(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\nposition: fixed;\nbottom: 0px;\nleft: 0px;\ntransition: top 0.2s ease 0s;\ndisplay: flex;\n-moz-box-pack: justify;\njustify-content: space-between;\n-moz-box-align: center;\nalign-items: center;\npadding-left: 8px;\npadding-right: 16px;\nwidth: 100%;\nheight: 35px;\nbackground-color: rgb(192, 192, 192);\nborder-bottom: 2px solid rgba(133, 133, 133, 0.1);\nz-index: 20;\ntransform: translate3d(0px, 0px, 0px);\nbox-shadow:0 2px 2px 3px lightgray;\n"], ["\nposition: fixed;\nbottom: 0px;\nleft: 0px;\ntransition: top 0.2s ease 0s;\ndisplay: flex;\n-moz-box-pack: justify;\njustify-content: space-between;\n-moz-box-align: center;\nalign-items: center;\npadding-left: 8px;\npadding-right: 16px;\nwidth: 100%;\nheight: 35px;\nbackground-color: rgb(192, 192, 192);\nborder-bottom: 2px solid rgba(133, 133, 133, 0.1);\nz-index: 20;\ntransform: translate3d(0px, 0px, 0px);\nbox-shadow:0 2px 2px 3px lightgray;\n"])));
...
var templateObject_1$E, templateObject_2$e, templateObject_3$7, templateObject_4$2, templateObject_5$1;
...
var alertTypeMap = (_a$1 = {},
    ...
    _a$1);
var StyledToast = styled__default['default'].div(templateObject_1$F || (templateObject_1$F = __makeTemplateObject(["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"], ["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var StyledToastContainer = styled__default['default'].div(templateObject_1$G || (templateObject_1$G = __makeTemplateObject(["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"], ["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"])));
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#C0C0C0", backgroundDisabled: "#c0c0c0", contrast: "#C0C0C0", invertedContrast: "#c0c0c0", input: "#eeeaf4", tertiary: "#c0c0c0", text: "#bf0411", textDisabled: "#bf0411", textSubtle: "#bf0411", borderColor: "#bf0411", card: "#C0C0C0", gradients: {
